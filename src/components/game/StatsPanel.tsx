...
const STAT_META: Record<keyof Stats, { label: string; icon: string; color: string }> = {
  ...
  cash: { label: "Cash", icon: "🪙", color: "oklch(0.72 0.18 130)" },
  income: { label: "Income", icon: "↗️", color: "oklch(0.72 0.18 130)" },
  expenses: { label: "Expenses", icon: "↘️", color: "oklch(0.65 0.24 25)" },
  debt: { label: "Debt", icon: "🏷️", color: "oklch(0.65 0.24 25)" },
  savings: { label: "Savings", icon: "🏦", color: "oklch(0.72 0.18 155)" },
  rent: { label: "Rent", icon: "🏠", color: "oklch(0.7 0.18 350)" },
