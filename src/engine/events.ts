...
export const EVENTS: GameEvent[] = [
  // ---------------- AGE 16 ----------------
  {
    ...
    sceneType: "home",
    location: "Bedroom",
    environment: "Early morning light",
    focus: "Start the day",
    tone: "neutral",
    weight: 30,
  ...
  },
  {
    ...
    emoji: "🚗",
    sceneType: "street",
    location: "Driving test route",
    environment: "Wide residential street",
    focus: "Prove yourself",
    tone: "neutral",
    weight: 20,
  ...
  },
  {
    ...
    emoji: "🚀",
    sceneType: "meeting",
    location: "Startup desk",
    environment: "Late-night glow",
    focus: "Take the leap",
    tone: "positive",
    weight: 100,
  ...
  {
    id: "first_apartment",
    title: "A Key You Can Actually Use",
    description: "The landlord slides a key across the desk. The apartment is tiny, but it is yours if you sign today.",
    category: "home",
    emoji: "🏠",
    sceneType: "home",
    location: "Leasing office",
    environment: "Bare walls and a paper lease",
    focus: "Build a life",
    momentTitle: "First apartment",
    tone: "positive",
    weight: 18,
    requires: { minAge: 19, maxAge: 24, notFlags: ["first_apartment"] },
    choices: [
      {
        id: "sign_lease",
        label: "Sign the lease",
        effects: {
          stats: { money: -20, happiness: 6, stress: 5 },
          traits: { responsibility: 4, ambition: 2 },
          flags: ["first_apartment"],
          memory: { title: "Moved into your first apartment", description: "Small rooms. Big feeling.", category: "home", tone: "positive", icon: "🏠" },
        },
      },
      {
        id: "keep_rooming",
        label: "Stay with roommates a little longer",
        effects: {
          stats: { money: 5, stress: -2 },
          traits: { discipline: 2 },
        },
      },
    ],
